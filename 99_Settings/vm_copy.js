!function() {
    ...
    } ('.docsify-copy-code-button{z-index:1;right:0;padding:8px;opacity:0;border:0;border-radius:0;outline:0;cursor:pointer}.docsify-copy-code-button,.docsify-copy-code-button:after{position:absolute;top:0;background:#42b983;color:#fff;transition:all .25s ease}.docsify-copy-code-button:after{content:"复制成功";z-index:0;right:100%;margin:5px 10px 0;padding:5px;border-radius:3px;font-size:11px;-webkit-transform:translateX(120%) scale(0);transform:translateX(120%) scale(0)}.docsify-copy-code-button.success:after{-webkit-transform:translateX(0) scale(1);transform:translateX(0) scale(1)}pre[v-pre]:hover .docsify-copy-code-button{opacity:1}'),
    ...
    window.$docsify.plugins = [function(e, o) {
        e.doneEach(function() {
            Array.apply(null, document.querySelectorAll("pre[v-pre]")).forEach(function(e, t, n) {
                ...
                c.appendChild(document.createTextNode("点击复制")),
                ...
                function(o) {
                    ...
                    i.addRange(t);
                    try {
                        document.execCommand("copy") && (c.classList.add("success"), setTimeout(function() {
